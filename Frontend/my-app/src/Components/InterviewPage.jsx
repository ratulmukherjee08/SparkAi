  ...
  return (
    <div className='bg-slate-200'>
      <div className="w-full h-14 flex justify-between items-center bg-emerald-600">
        ...
        <div>
          <Link to="/anylasis">
          {/* <button  className="bg-sky-950 w-34 h-8 rounded-sm text-white rounded-2 m-4 hover:bg-white hover:text-black font-mono font-bold ">
            Analysis
          </button> */}
          <button onClick={handleClick} class="bg-sky-950 hover:bg-white hover:text-black text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">
          Analysis Report
</button>
          </Link>
